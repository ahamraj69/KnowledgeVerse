...
export default function ReviewCommentCard({ comment }: { comment?: string }) {
  return (
    <View style={styles.box}>
      <Text style={styles.title}>💬 OFFICIAL EVALUATION REMARKS</Text>
      <Text style={styles.text}>{comment ? comment : "No active review comments or corrections requested."}</Text>
    </View>
  );
}
